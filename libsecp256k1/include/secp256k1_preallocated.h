 ...
 * module) instead of erigon_secp256k1_context_destroy (in secp256k1.h).
 *
 ...
 *
 *  See also erigon_secp256k1_context_randomize (in secp256k1.h)
 ...
 *  If the context has instead been created using erigon_secp256k1_context_create or
 *  erigon_secp256k1_context_clone, the behaviour is undefined. In that case,
 *  erigon_secp256k1_context_destroy must be used instead.
 *
